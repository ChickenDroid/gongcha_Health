...
public class Training_batsal extends AppCompatActivity {
    private batsal_Adapter recyclerAdapter_training1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView=findViewById(R.id.infor);
        ...
        recyclerAdapter_training1 = new batsal_Adapter();
        ...
        if (nodata) {
            ...
            if(randomValue==0)
                Glide.with(getBaseContext()).load("https://img.huffingtonpost.com/asset/5d813dff240000d3267d49db.gif?ops=scalefit_630_noupscale").override(500, 300).into(imageView);
